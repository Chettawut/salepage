<?php
    ...
    $StrSQL = "INSERT INTO user (`username`, `password`, `firstname`, `lastname`, `tel` ,`email`, `type`,`register_date`,`register_time`) ";
    $StrSQL .= "VALUES (";
    $StrSQL .= "'".$_POST["userusername"]."','".$password."','".$_POST["userfirstname"]."','".$_POST["userlastname"]."','".$_POST["usertel"]."' ";
    $StrSQL .= ",'".$_POST["useremail"]."','".$_POST["usertype"]."','".date("Y-m-d")."','".date("H:i:s")."' ";
    $StrSQL .= ")";
